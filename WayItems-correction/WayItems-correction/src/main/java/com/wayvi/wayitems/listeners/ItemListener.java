...
public class ItemListener implements Listener {
    ...
    public void onPlayerHitEntity(EntityDamageByEntityEvent event) {
        if (event.getDamager() instanceof Player) {
            //ici dans les instanceof tu peux utiliser le pattern matching de java 16
            // ca donne if(even.getDamager() instanceof Player player) et tu peux use player en tant que variable
